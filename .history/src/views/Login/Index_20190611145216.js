                ...
                <div className='login'>
                    ...
                    <div className='login_fields'>
                        <div className='login_fields__user'>
                            ...
                            <input name="login" placeholder='用户名' type='text' autocomplete="off" value="kbcxy"/>
                        ...
                        <div className='login_fields__password'>
                            ...
                            <input name="pwd"  placeholder='密码' type='text' autocomplete="off" />
                            <div className='validation'>
                                <img alt="" src='./img/tick.png' />
                            </div>
                        </div>
                        ...
                        <div className='login_fields__password'>
                            ...
                            <input name="code" placeholder='验证码' type='text' name="ValidateNum" autocomplete="off" />
                            <div className='validation' style={{opacity: 1,right: '-5px',top: '-3px'}}>
                                <canvas className="J_codeimg" id="myCanvas" onclick="Code();">对不起，您的浏览器不支持canvas，请下载最新版浏览器!</canvas>
                            </div>
                        </div>
